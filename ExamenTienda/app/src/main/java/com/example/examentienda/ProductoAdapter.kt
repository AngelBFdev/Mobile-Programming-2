...
class ProductoAdapter(private val mContext: Context, private val listaProducto: List<Producto>): ArrayAdapter<Producto>(mContext, 0, listaProducto ) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        layout.cantidad.text= producto.cantidad.toString()
        layout.preciocosto.text= "${producto.precioCosto}"
        layout.precioventa.text="${producto.precioVenta}"
        layout.imageView.setImageResource(producto.fotoUrl)
